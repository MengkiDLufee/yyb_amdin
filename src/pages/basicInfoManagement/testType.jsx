        ...
        if(record.functionMethod) {
            ...
            this.setState({
                ...
                this.setState({
                    ...
                    axios.post('http://123.57.33.240:8080/test/type/judgeTips/imageUrl',{
                        judgeTipsId:record.judgeTipsId
                    }) .then(function (response) {
                        _this.setState({
                            pictureSource:response.data.data
                        },()=>{
                            console.log("图片",_this.state.pictureSource)
                        })
                    })
        ...
        return (
            <div>
                ...
                <Modal
                    ...
                    footer={[]}>
                    <Spin spinning={!this.state.isload}></Spin>
                    <Image
                    ...
                    <Form {...formItemLayout}
                        ...
                        >
                            ...
                            <Upload
                                    ...
                                    action="http://123.57.33.240:8080/test/type/judgeTips/updateImage" //上传的地址
                                    //listType="picture"
                                    maxCount={1}
