...
import TestData from "./Modal/testData"
import HisTestData from "./Modal/hisTestData"
const { Option } = Select;
export default class UserTestDataManagement extends Component {
    constructor(props) {
        super(props);
    }
    state = {
    ...
    columns = [
        ...
        },
        {
            ...
            render: (a) => (
                <div>
                    <div style={{display:'inline-block'}}><TestData {...this.state.dataSource[0]}></TestData></div>
                    <div style={{display:'inline-block'}}><HisTestData {...this.state} {...a}></HisTestData></div>
